...
19. 2026-08-22 负责人已批准 `docs/us_presence_network_wave2_research_command_v1.md` 的八项研究决定，并完成 W2-00 七项检查点决定。W2-00 统一锚点包现有 9 套选择框、152 条锚点、43 条权威来源收据、41 件本地原件、24 条 change note 与 4 套案例量尺；OESC→AWWA 三税期官方 Schedule I 行均为 `human_checked`，recipient EIN 均为 98-0227149。W2-A／B／C／E 已放行 `research_only`，W2-D 等 W2-A 端点，W2-F 等上游资产，W2-G 中央写回与前端发布仍未授权。
