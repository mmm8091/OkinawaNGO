...
19. 2026-08-22 已形成 `docs/us_presence_network_wave2_research_command_v1.md` 负责人审阅稿：一期报告、8,000—12,000 字论文与 PPT 统一以“同一驻军、两套公民基础设施”为脊柱；AWWA／五家军属俱乐部、USO、问责结果三案先做锚点法，Bridge audit 与 LEG2 设独立检查点，1972—2012 历史线压缩为背景章。当前只待八项负责人决定，尚未授权第二轮采集、中央写回或前端发布。
