...
14. 冻结后线上补强按 `docs/post_freeze_online_enrichment_plan_v1.md` 执行：先修 LC001–LC004 的 L2 导出与5张冻结图，再依次做 NR-05、转译负案例；H3/H2 只选一个先跑，且每个解释模块完成后暂停给负责人阅读。HR-035 Batch 2 尚未正式派发。
