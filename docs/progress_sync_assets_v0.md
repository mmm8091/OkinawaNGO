...
前述第 1–11 节保留为第一次/第二次同步时的历史快照，不再用于判断当前内部进度。当前数据为 118 个组织级 actors、247 sources、222 actor–issue 候选/人审边、125 actor–place 边、43 funding/support/non-funding relation 样本边；另有 49 条正式 evidence note、65 条正式 actor–event–venue、6 案 R8 case registry 和 27 条人审角色。HR-011–015 已回写；HR-013 新增 A111，HR-010 范围修正移出 A094，净数仍为 118。S199–S247 中 48 条已归档，S213 为 403；来源入表不批准候选关系或解释。
...
Registry 必须满足原方案 120–180 的一期范围；当前仍少 2。post-HR013 审计有 17 个在表 actor 尚无正式 edge，其中 16 个已有 54 条候选边待 HR-010／HR-024，A073 为线上耗尽。下一轮从能修复模块缺层且闭合持续身份／一期直接连接的候选中补样，优先宮古島地下水研究会和 PFAS／健康、先岛、女性／劳工薄层；不得把旧 A077–A085、A094 或一般公益组织重新入表凑数。

下一轮对外沟通前，应优先形成：

1. R1/R2 已按 HR-013 重生为 118×26、222 边；R8 六案比较图已完成。HR-016–022 与 HR-024 继续控制未决判断，原始候选包不直接并主表。
2. 下一轮 P0 补 R3 空间关系语义与与那国／石垣／宫古 dossier，并补 R9 的 2014／2018／2022 选举—市民组织接口。
3. 下一轮 P1 做 R5/R7 异质行动比较、价值驱动 registry 补样及 schema/alias 冻结；共同出现、流程顺序和选举介入均不作稳定联盟或因果效果解释。
4. 以上回收后，把 25–35 页 DOCX/PDF 报告推进为正式交付，再派生 8k–12k 论文和 15–20 页 PPT；由报告中的精确证据缺口反推当地协作者任务包。
