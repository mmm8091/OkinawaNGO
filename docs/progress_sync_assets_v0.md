...
Registry 必须满足原方案 120–180 的一期范围；当前 103 尚未达标。扩样仍按模块缺层推进，若达到 180 后 R1–R11 仍未饱和可继续扩。2020 MMC Tier A 9 个组织已入表；Tier B 12 个组织只有在形成独立本土声援层并服务 R5/R6 时才分层纳入；Tier C 31 个一次性署名者维持事件限定。
