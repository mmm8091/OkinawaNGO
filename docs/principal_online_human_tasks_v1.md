...
当前计数详表：`docs/principal_human_review_remaining_v17.md`。

## 1. 一句话状态

本任务单列出的 **160 个正式线上人工决定已于 2026-07-20 全部由负责人确认并完成受控
合并**：
...
当前线上正式人工任务为0。另有12个当地／新一手材料项：HR-017九项、HR-018两项和
HR-024/A073一项；其中 HR-018 两项已有 `deferred_local_or_internal_record` 决定，等待
新材料后闭合。以下批次说明保留为派工审计轨迹，不再是待办清单。
