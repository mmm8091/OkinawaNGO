...
当前计数详表：`docs/principal_human_review_remaining_v15.md`。

## 1. 一句话状态

当前尚有 **160 个正式线上人工决定**：

- **116 个现在可以分批进行**：HR-035 Batch 1 的 15 项、HR-010 批 6 的 47 项、LCR001–004 的 4 项、HR-034 的 50 项；
- **41 个要在上述决定合并并重生后进行**：HR-029 schema／alias freeze；
- **3 个最后进行**：HR-031 报告解释强度；
- 另有 **12 个当地／新一手材料项**，不在本线上任务单内。

HR-016 至 HR-033 中已有负责人回交的线上决定均已合并。当地层目前有 10 个空白决定（HR-017 local 9、HR-024 A073 1）；HR-018 local 2 已决定 `deferred_local_or_internal_record`，等待新材料后闭合，并非空白。
