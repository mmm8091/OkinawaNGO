...
- U.S.-presence multilayer network wave 2: `docs/us_presence_network_wave2_research_command_v1.md`, `docs/us_presence_network_wave2_w2_00_principal_checkpoint_v1.md`, and `outputs/us_presence_network_wave2_w2_00_v1/`
  ...
  - W2-A, W2-B, W2-C and W2-E are authorized for `research_only` work. W2-D waits for W2-A dated people/recipient endpoints; W2-F waits for stable upstream assets and the principal interpretation checkpoint; W2-G central writeback, publication adapter and frontend release remain unauthorized. Use `outputs/us_presence_network_wave2_w2_00_v1/work_package_release_v1.csv` as the machine-readable authorization record.
