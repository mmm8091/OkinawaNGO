...
- U.S.-presence multilayer network wave 1: `docs/us_presence_network_research_wave_v1.md`, `docs/us_presence_network_architecture_v1.md`, `docs/us_presence_network_wave1_principal_checkpoint_v1.md`, and `outputs/us_presence_*`
  ...
  - The actor directory candidate has 121 active actors, 65 formal-page candidates and 56 `not_found`; 40 page decisions can be batch-reviewed and 25 require individual conflict review.
  - The service recon has 18 actor/program observations, 29 person roles, 14 typed resource-flow candidates, 16 recipient observations and 12 discourse/service observations (L0=3, L1=9, L2=0). The accountability recon has 8 scoped actors, 11 person roles, 9 action/relation observations and 2 resource observations. All remain `research_only` and not frontend-ready.
  - The legacy 43-row relation sample is mapped without fact changes to 8 money, 4 service-recipient, 9 affiliation, 20 action-institution, 1 lead and 1 history-only row. Six blank group decisions replace 43 repetitive mapping decisions.
  - New pending USN review packets are outside the old central ledger: 65 directory fields, 6 relation mapping groups, 9 accountability decisions and 13 service-ecology decisions. Do not write a merger or publication adapter until these returns and the five-item principal architecture checkpoint are complete.
