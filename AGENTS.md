...
- Exploration system: `outputs/exploration_system_data_v1/`, `prototypes/nr3_explorer/`, and `docs/nr3_handoff_v1.md`
  - Current reviewed/research views hide A072 and AI068 from default use. The typed relation layer separates 14 reviewed dyadic relations, 8 candidate dyadic relations, administrative records, aggregate observations, event participation and 27 case roles. Builder validation, 79 Python tests and the production frontend build pass.
