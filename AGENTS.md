...
- Live human-review ledger: `docs/principal_human_review_remaining_v17.md`
  - All formally dispatched online review items are closed and merged. Twelve local/new-primary-material items remain: HR-017 nine, HR-018 two already deferred pending new material, and HR-024/A073 one. Undispatched HR-035 follow-on debt is not counted as a formal open task.
...
- Second post-audit online wave:
  ...
  - `outputs/human_review_orchestration_v1/`: historical pre-merge orchestration snapshot; use `docs/principal_human_review_remaining_v17.md` for the live 12-local-item ledger.
...
- Safe current message: all formally dispatched online reviews through HR-035 Batch 1 are integrated; the registry has 122 history rows/121 active actors and actor–issue has 294 history/283 active edges (125 reviewed/158 candidate). The place-issue replacement has 305 active same-source triples (71 dual-reviewed). Only 12 local/new-primary-material review items remain formally open. The exploration frontend is regenerated and browser-checked; its remaining structural gap is the zero-anchor L2 export despite five reviewed central lifecycle records. Final contract artifacts still do not exist.
