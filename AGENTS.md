...
- U.S.-presence multilayer network wave 2: `docs/us_presence_network_wave2_research_command_v1.md`, `docs/us_presence_network_wave2_w2_00_principal_checkpoint_v1.md`, and `outputs/us_presence_network_wave2_w2_00_v1/`
  ...
  - The principal explicitly blocked W2-F on 2026-08-22. The unqualified 47k figure label is now corrected, and three information-disclosure drafts are frozen as `draft_not_sent`. Before synthesis, complete `docs/human_review_assignment_USN_wave2_ABCD_v1.md`, add one bounded matched non-entry arm and the key LEG2 originals, and actually send/register the three requests covering HQ00342310002 regional allocation, MCCS financial statements and Okinawa Defense Bureau itemized expenditure. W2-G central writeback, publication adapter and frontend release remain separately unauthorized.
