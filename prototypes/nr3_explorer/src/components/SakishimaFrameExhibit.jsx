...
const COPY = {
  zh: {
    ...
    methodFallback: "计数呈现限定线上语料中各框架的可见度。",
    fullLimit: "查看完整边界",
    placeTabs: "选择比较地点",
    allFrames: "全部框架",
    observations: "正式观察",
    ...
    actorHint: "打开组织页",
    unitNote: "同一材料可承载多个框架；正式观察与摘录分别呈现。",
    reviewedRow: "人工复核",
    researchRow: "QA-safe",
  ...
  ja: {
    ...
    actorHint: "団体ページを開く",
    unitNote: "同じ資料が複数のフレームを持つ場合があります。正式観察と抜粋は別々に表示します。",
  ...
  en: {
    ...
    unitNote: "One source may carry multiple frames; formal observations and excerpts are presented separately.",
