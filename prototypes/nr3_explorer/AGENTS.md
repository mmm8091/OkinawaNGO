...
- Public-facing hierarchy: the site is a presentation, not an internal workbench. Default screens lead with the research object or question, never build IDs, module/catalog codes, review workflow, retrieval plans, or defensive caveats. A selected subview owns the page title; do not retain a generic parent title above it. Method boundaries remain reachable through help, evidence drawers, or deliberate expansion, while raw IDs/statuses appear only in research view or drill-down.
