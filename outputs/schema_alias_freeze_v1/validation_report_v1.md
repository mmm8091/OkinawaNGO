...
- Aliases: 27 rows; zero normalized cross-actor collisions; one documented same-actor punctuation collision.
- Places: 20 nodes and 135 actor–place edges; AP123 captured as `defer_to_HR025` / needs-human, with no HR-029 duplicate and no silent P007 proposal.
...
- Unified candidates: 483 unique rows; every row has a proposed value and explicit interpretation boundary.
- HR-029: 36 stable rows; 0 currently contain human/final/status values; cross-linked one-to-one.
...
- Two figures generated in PNG/SVG; SVG line-tail whitespace normalized after save; deterministic non-figure digest: `a3f8ae0a1564d68d`.
