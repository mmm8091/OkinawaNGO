...
- `330` document-level same-source triples were found.
- `323` are E3/E4 strict candidates.
- `67` have both underlying edges human-reviewed.
- `100` strict triples can also be attached to a formal event observation through the same actor/source pair.
