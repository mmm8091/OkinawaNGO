...
目的：把当前 118 个 actor、247 条 source 和人工复核状态转成可沟通、可继续探索的图件。此包不是最终报告；它用于下一次沟通前验证叙事，并暴露下一轮补源方向。HR-011/012/014/015 已回写；HR-013 尚未收到；A087-A101 仍只完成 E4 身份级合并，A077-A085 依 HR-015 仅保留为 E2 事件参与者、不进入 registry。
...
1. 手工处理 19 条自动归档失败来源；失败状态不等于证据不存在。
