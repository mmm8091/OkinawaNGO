...
Generated by `python scripts/make_r03_spatial_dossier_v1.py`.
    ...
    - 135/135 actor-place edges receive one candidate semantic.
    - 17 underlying edges are human-reviewed; 118 remain candidate/status-limited.
- 47 unresolved semantic decisions are routed to HR-025; 0 rows currently contain preserved human fields.
- Sakishima dossier coverage: Yonaguni 6, Ishigaki 3, Miyako 3 actor-place rows.
    - The source crosswalk has 214 rows, including all 186 expanded refs from the actor-place table.
