...
规范化后共有 **35 条关系观察、26 条金额观察、43 条功能观察**。机制生态图完整分为上层行政机制 **16 条**与下层服务／慈善／非资金边界 **19 条**，合计 16+19=35。

关系类型完整计数为：commission 14、designated_role 1、grant 2、sponsorship 3、donation 1、network_membership 5、in_kind_donation 3、joint_in_kind_contribution 1、service_presence 1、aggregate_history 2、grant_opportunity 1、event_collaboration 1；以上恰好覆盖全部 35 条，没有把活动协作或慈善 grant 隐入其他类型。
...
3. **A066 与 A088 的三份合同可确认为采购合同。** 精确合同额分别为 12,842,500、26,439,000、8,479,000 日元；它们证明具体年度的受托关系，不证明 grant、无条件行政支持、稳定政治联盟或“运动资金”。
