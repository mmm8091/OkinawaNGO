...
EPISODES = [
    {
        ...
        "interpretation_limit": "程序标准与信息生产不等于工程被阻止；原告身份严格按案号。",
    },
    {
    ...
    },
    {
        ...
        "venue": "条例直接请求、议会与义务付诉讼", "observable_output": "签名门槛达成；议会两度否决；法院明确可诉性门槛",
    ...
    },
    {
        ...
        "venue": "住民监查与公金支出差止诉讼", "observable_output": "生态争议转成支出与行政裁量审查",
        "substantive_result": "第一波限制支出；第二波居民败诉，结果相反",
    ...
    },
    {
        ...
        "interpretation_limit": "咨询型反对多数不是法律否决；A068 规范名仍待人工决定。",
    },
    {
    ...
    {
        "episode_id": "TE11", "module": "HR027/R2-R4", "case_id": "HR027E004/E005", "short_label": "宜野湾 PFAS 采样→议会",
        "actor_ids": "A113", "place": "Ginowan;Futenma", "route_family": "resident_sampling_petition",
        "local_problem": "学校／社区 PFAS 风险", "translation_frame": "居民筹资采样与健康调查请求",
        "venue": "采样、请愿与市议会意见书", "observable_output": "市议会正式记录采样，并形成污染对策意见",
