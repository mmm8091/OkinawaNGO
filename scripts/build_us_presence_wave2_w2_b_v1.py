...
def render_waterfall_svg(path: Path) -> None:
    ...
    parts = [
        ...
        svg_card(730, 598, 650, 154, "具名本地资源流与运作规模", ["AEC USD 18k (2024); AK Kogyo JPY 1m (2025)", "AEC USD 16k; OESC USD 3.25k (2025)", "6 centers + terminal entry + area office", "21 employees / 780+ volunteers / approx. 47k population"], tone="teal"),
